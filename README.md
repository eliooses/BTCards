...
| 	BitShares	| 	[![alt text][web]](https://wallet.bitshares.org/) | [![alt text][github]](https://github.com/bitshares)	| [![alt text][whitepaper]](http://docs.bitshares.org/bitshares/papers/) | `ACL` `DCD` `DC` `DD` `DG` `FULLY`| 	(live)	| 	bitshares protocol (DPOS)	| 1,5,6 	| Bitshares, Bitshares SmartCoins, bitUSD, bitCNY, bitEUR | Bitshares |  | |
